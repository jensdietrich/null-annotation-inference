...
public class SantitiseObservedIssues {
    ...
    public static void run (ProjectType project, File originalIssueFolder, File sanitisedIssueFolder, File negativeTestList, Map<String,Integer> counts, Predicate<Issue> issueFilter) throws Exception {
