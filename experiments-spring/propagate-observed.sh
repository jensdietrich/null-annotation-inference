...
## propagate observed (captured) and sanitized annotations by applying LSP
...
for module in "${MODULES[@]}" ;do
    ...
    java -Xmx16g -jar $PROPAGATOR -p ${PROJECT_FOLDER}/${module} -t gradle_multilang -i ${RESULT_FOLDER_SANITIZED}/$NULLABLE-${module}.json -o ${RESULT_FOLDER_OBSERVED_PROPAGATED}/$NULLABLE-${module}.json -x $prefix
done
