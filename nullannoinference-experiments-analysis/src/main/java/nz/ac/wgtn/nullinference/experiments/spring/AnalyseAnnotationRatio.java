...
//        Thread.sleep(10_000);  // time to connect profiler
    ...
    public void analyse()  {
        ...
        TableGenerator latexOutput = new LatexTableGenerator(OUTPUT_LATEX,"|lrrr|rrr|");

        this.run(FULL_DATASET,"Annotated vs annotatable program elements by type (f - field, a - argument, r - return type)","tab:annotation-ratio",columns,csvOutput,latexOutput);
    }
